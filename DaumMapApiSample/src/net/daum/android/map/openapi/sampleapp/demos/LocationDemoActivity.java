    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (itemId) {
            ...
            case MENU_REVERSE_GEO: {
                mReverseGeoCoder = new MapReverseGeoCoder(MapApiConst.DAUM_MAPS_LOCAL_API_KEY, mMapView.getMapCenterPoint(), LocationDemoActivity.this, LocationDemoActivity.this);
